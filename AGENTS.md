...
- `AI正文净化功能计划书.md` —— AI 正文后处理范围与安全边界（阶段 A/B/C/D 已完成代码级验收，唯一下一步为阶段 E：真机回归与发布前验收）；
- `docs/AI正文净化/` —— AI 各阶段 DSH 协作任务书/实施报告/审查，以及 `AI正文净化-锚点兼容与发布验收计划书.md`（阶段 E 当前执行入口：先细分 ANCHOR，再最小修正和真机验收）；
