...
1. `D:\vsproject\legado-E\.agent-protocol\tasks\ai-stage-e-anchor\00-task.md` —— 任务书。目标、非目标、授权范围、完成条件、停止条件都以它为准。
...
5. 需要时读上一环：`D:\vsproject\legado-E\.agent-protocol\tasks\ai-stage-e-anchor\00-task.md`。

## 你的产出

把结果写进 10-execution.md。这是你这个角色唯一可写的文件，不得修改其他角色原文。

在 `D:\vsproject\legado-E\.agent-protocol\tasks\ai-stage-e-anchor\10-execution.md` 里如实记录：
...
- 碰到停止条件就停下并在 `D:\vsproject\legado-E\.agent-protocol\tasks\ai-stage-e-anchor\10-execution.md` 里写明原因，不要硬着头皮往下做。
